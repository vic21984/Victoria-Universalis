...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.15, -- fraction of ships in the navy that should be ships of the line
	AI_LIGHTSHIP_PROPORTION = 0.45, -- fraction of ships in the navy that should be cruisers, frigates etc
