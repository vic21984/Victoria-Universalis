...
country = {
	...
	CONSERVATIVE_INCREASE_AFTER_REFORM = 0.2, -- how many more conservatives in a upper house.
	...
	INVESTMENT_SCORE_FACTOR = 0.0, -- how much foreign investment money counts towards your industry score
	...
	COLONIZATION_INTEREST_COST = 80,
	COLONIZATION_INFLUENCE_COST = 40,
	COLONIZATION_EXTRA_GUARD_COST = 40,
...
economy = {
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.4, -- % of how much we pay to the pops and capitalists, from the leftovers.
...
military = {
	...
	NAVAL_COMBAT_SPEED_TO_DISTANCE_FACTOR = 0.5, -- cast the ship speed to the "in combat" speed that moves it towards center line on the field range 0-1.
	...
	AI_BLOCKADE_RANGE = 20000, -- max distance the AI will send out blockade fleets from their home base
	...
	NAVAL_LOW_SUPPLY_DAMAGE_SUPPLY_STATUS = 0.3, -- how little supply is acceptable before getting damage to STR
...
diplomacy = {
	...
	TWS_BATTLE_MAX_ASPECT = 10, -- Max allowed battle wins aspect for TWS
...
pops = {
	...
	PROMOTION_ASSIMILATION_CHANCE = 1,
	LUXURY_THRESHOLD = 0,
	BASE_GOODS_DEMAND = 0.8,
	BASE_POPGROWTH = 0,
	MIN_LIFE_RATING_FOR_GROWTH = 50,
	...
	PDEF_BASE_CON = 6.67,			-- so half'ed effect.
	...
	POPULATION_MOVEMENT_RADICAL_FACTOR = 200,
...
ai =
{
	...
	PRODUCTION_WEIGHT = 1, -- ai weight for new production
	...
	POP_PROJECT_INVESTMENT_MAX_BUDGET_FACTOR = 1, -- how much % of our current budget can be spend on the pop project investments.
	...
	MONTHS_BEFORE_DISBAND = 2, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil)
},
